            ...
            <div className="flex-1 lg:flex lg:items-center lg:-mx-6">
              <div className="text-white lg:w-1/2 lg:mx-6">
                ...
                <p className="max-w-xl mt-6">
                  We are dedicated to fighting hunger and providing nutritious
                  food to those in need. Whether you have questions, want to
                  volunteer, or wish to make a donation, we would love to hear
                  from you. Together, we can make a difference in our community.
                </p>
                <button className="px-8 py-3 mt-6 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-[#4682B4] hover:bg-[#4169E1] focus:outline-none focus:ring focus:ring-blue-400 focus:ring-opacity-50">
                  get in touch
                </button>
                <div className="mt-6 md:mt-8">
                  ...
                  <div className="flex mt-4 -mx-1.5">
                    ...
                    <a target="blank"
                      className="mx-1.5 text-white transition-colors duration-300 transform hover:text-blue-500"
                      href="https://www.instagram.com/n.h._rafi"
                    >
                      <svg
                        className="w-8 h-8"
                        viewBox="0 0 24 24"
              ...
              <div className="mt-8 lg:w-1/2 lg:mx-6">
                <div className="w-full px-8 py-10 mx-auto overflow-hidden bg-white shadow-2xl rounded-xl lg:max-w-xl">
                  ...
                  Have questions about donating food or volunteering? Reach out to us, and we would love to assist you in making a difference.
                  </p>
                  <form className="mt-6">
