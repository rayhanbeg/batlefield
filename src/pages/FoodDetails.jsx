...
const FoodDetails = () => {
 ...
 console.log(food);
  ...
  const handleRequest = () => {
    openModal();
    // Additional logic for handling request can be added here
  };
    return (
        <div>
      ...
      <div className="mb-8">
        ...
        <p>Donor Name: {donator?.donatorName}</p>
        <p>Food Pickup Location: {pickupLocation}</p>
      </div>
      
      <div className="mb-8">
        <h2 className="text-xl font-bold mb-4">Single Food Section:</h2>
        <div className="flex items-center mb-4">
          <img src={foodImageURL}  className="w-20 h-20 object-cover rounded mr-4" />
          <div>
